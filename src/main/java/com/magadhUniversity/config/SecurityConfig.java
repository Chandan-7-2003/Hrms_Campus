    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/students/**").hasAnyRole("ADMIN","STUDENT","EMPLOYEE")
                        .requestMatchers("/employees/**").hasRole("ADMIN")
                        .requestMatchers("/employees/attendance/**").hasAnyRole("ADMIN", "EMPLOYEE")
                        .requestMatchers("/employees/attendance/record").hasAnyRole("ADMIN","STUDENT","EMPLOYEE")
                        .requestMatchers("/student-marks/**").hasAnyRole("ADMIN","STUDENT","EMPLOYEE")
                        .requestMatchers("/subjects/**").hasAnyRole("ADMIN","STUDENT","EMPLOYEE")
                        .requestMatchers("/mark_attendance").authenticated()
                        .anyRequest().authenticated()
                )
                .formLogin()
